 ...
 */
//#define USE_CONTROLLER_FAN  // Disabled - not needed (E0_AUTO_FAN handles thermal block cooling)
 ...
 */
   ...
   */
  #define MONITOR_DRIVER_STATUS  // Enable runtime monitoring and current adjustment
   ...
   */
  #define TMC_DEBUG  // Enable M122 for driver diagnostics
