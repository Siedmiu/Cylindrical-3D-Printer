...
#define STRING_CONFIG_H_AUTHOR "(Grzegorz Lange 25.11.2025)" // Who made the changes.
 ...
 */
#define TEMP_SENSOR_0 1  // ender 3v2 therimistor
...
#define TEMP_SENSOR_BED 0  // No heated bed for cylindrical printer
...
#define POLAR
  ...
  #define PRINTABLE_RADIUS 153.0f           // (mm) Maximum travel of X axis - matches X_BED_SIZE
...
#define USE_XMIN_PLUG   // X-axis (left/right) endstop for homing
//#define USE_YMIN_PLUG  // Y-axis (rotation) doesn't need endstop - continuous rotation
#define USE_ZMIN_PLUG   // Z-axis (up/down) endstop for homing
...
#define X_MIN_ENDSTOP_INVERTING true  // Inverted for wiring
#define Y_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Z_MIN_ENDSTOP_INVERTING true  // Inverted for wiring
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 40, 71.50, 200, 72 }
// X: 40 steps/mm (calibrated)
// Y: 71.50 steps/degree (rotational, calibrated)
// Z: 200 steps/mm (calibrated)
// E: 72 steps/mm (calibrated)
/**
...
#define INVERT_X_DIR true   // Inverted for wiring
...
// :[-1,1]
#define X_HOME_DIR -1  // Home X to left (minimum position)
#define Y_HOME_DIR  0  // Y-axis (rotation) doesn't home - 0 = no homing direction
#define Z_HOME_DIR -1  // Home Z down to minimum (endstop at bottom)
//#define I_HOME_DIR -1
//#define J_HOME_DIR -1
//#define K_HOME_DIR -1
//#define U_HOME_DIR -1
...
#define X_BED_SIZE 153  // X-axis linear travel in mm
#define Y_BED_SIZE 360  // Y-axis rotation in degrees (can be >360 for multi-turn)

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0     // Minimum X position (left limit)
#define Y_MIN_POS -999999  // Effectively unlimited rotation (negative)
#define Z_MIN_POS 0        // Z=0 at drum surface
#define X_MAX_POS X_BED_SIZE  // Maximum X position (right limit)
#define Y_MAX_POS 999999   // Effectively unlimited rotation (positive)
#define Z_MAX_POS 65       // Maximum Z height (65mm from drum surface)
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  //#define MIN_SOFTWARE_ENDSTOP_Y  // Disabled for continuous rotation
...
#define MAX_SOFTWARE_ENDSTOPS
  ...
  //#define MAX_SOFTWARE_ENDSTOP_Y  // Disabled for continuous rotation
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (4*60) }  // Y-axis won't home (no endstop), value unused
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501 - Required for PID and E-steps
